...
- Пакет переехал в собственный scope — устанавливается как `@mefodiytr/n8n-nodes-max`. Это форк, основной репозиторий [pfrankov/n8n-nodes-max](https://github.com/pfrankov/n8n-nodes-max) живёт под прежним именем без изменений.
